...
def default_values():
	...
	data_source = [
		...
		{'param': 'rabbitmq_queue', 'value': 'rmon', 'section': 'rabbitmq', 'desc': 'RabbitMQ-server queue', 'group': '1'},
		{'param': 'rabbitmq_user', 'value': 'rmon', 'section': 'rabbitmq', 'desc': 'RabbitMQ-server user', 'group': '1'},
		{'param': 'rabbitmq_password', 'value': 'rmon123', 'section': 'rabbitmq', 'desc': 'RabbitMQ-server user password', 'group': '1'},
...
def update_db_v_1_1():
	try:
		...
		if e.args[0] == 'no such column: "en"' or str(e) == '(1060, no such column: "en")':
